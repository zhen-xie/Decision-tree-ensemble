...
data_path="./input/BASEHOCK.mat"
data = scio.loadmat(data_path)

data_train_label=data.get('X')
X = data_train_label.todense()

y = data_train_data=data.get('Y')
...
with open("data_BASEHOCK.txt", "w+") as f:
...
with open("model_BASEHOCK.txt", "w+") as f:

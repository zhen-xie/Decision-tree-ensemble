...
year_df = pd.read_csv('input/year_prediction.csv')

X_year = year_df.drop(['label'], axis=1)
y_year = year_df['label']
features = list(X_year.columns)
...
with open("data_year.txt", "w+") as f:
...
with open("model_year.txt", "w+") as f:

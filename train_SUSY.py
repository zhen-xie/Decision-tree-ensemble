...
SUSY_df = pd.read_csv('input/SUSY_mini.csv')

X_SUSY = SUSY_df.drop(['label'],axis=1)
y_SUSY = SUSY_df['label']
features = list(X_SUSY.columns)
...
with open("data_SUSY.txt", "w+") as f:
...
with open("model_SUSY.txt", "w+") as f:

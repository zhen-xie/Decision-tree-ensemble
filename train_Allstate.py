...
allstate_df = pd.read_csv('input/Allstate.csv')

X_allstate = allstate_df.drop(['loss', 'id'], axis=1)
y_allstate = allstate_df['loss']
features = list(X_allstate.columns)
...
with open("data_allstate.txt", "w+") as f:
...
with open("model_allstate.txt", "w+") as f:
